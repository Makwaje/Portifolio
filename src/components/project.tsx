...
export default function Project({
  ...
  const {} = useScroll({ target: ref, offset: ["0 1", "1.33 1"] });
  return (
    <motion.div
      style={{
        scale: scaleProgress,
    ...
    >
      <section
        className="relative mb-3 max-w-[42rem] overflow-hidden rounded-xl border border-black/5 bg-gray-100 transition last:mb-0 hover:bg-gray-200 dark:bg-white/10 dark:text-white
      dark:hover:bg-white/20 sm:mb-8 sm:h-[20rem] sm:pr-8
      "
      >
